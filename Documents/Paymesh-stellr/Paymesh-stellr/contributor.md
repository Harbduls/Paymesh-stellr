...
Welcome to Paymesh! We're building a payment solution on the Stellar network, and we're excited to have you contribute. This guide will help you understand what's expected and how to make meaningful contributions.
...
### Design Reference
- **Figma Design**: [Paymesh Figma](https://www.figma.com/design/zD33uUXS5EthAYdjMI2SBB/Paymesh?node-id=463-3&p=f&t=g4f6PtO04SpL40ky-0)
...
### 1. Fork and Clone
```bash
git clone https://github.com/YOUR_USERNAME/Paymesh-stellr.git
cd Paymesh-stellr
```
...
Help us push Paymesh on the Stellar network fast by:
...
Every contribution matters. Whether you're fixing a bug, adding a feature, or improving documentation, you're helping build something meaningful on Paymesh.
